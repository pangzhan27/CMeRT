...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='',
        type=str,
        help='path to yaml configs file',
    )
    parser.add_argument(
        '--gpu',
        default='0',
...
def assert_and_infer_cfg(cfg, args):
    ...
    cfg.MODEL.LSTR.TOTAL_MEMORY_LENGTH = cfg.MODEL.LSTR.LONG_MEMORY_LENGTH + cfg.MODEL.LSTR.WORK_MEMORY_LENGTH
    ...
    cfg.MODEL.LSTR.TOTAL_MEMORY_NUM_SAMPLES = cfg.MODEL.LSTR.LONG_MEMORY_NUM_SAMPLES + cfg.MODEL.LSTR.WORK_MEMORY_NUM_SAMPLES
...
def load_cfg():
    ...
    if args.config_file is not None:
        cfg.set_new_allowed(True)  ## added by pang
